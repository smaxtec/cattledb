...
from .helper import get_test_connection, get_test_events, get_unit_test_config
...
class EventStorageTest(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        res = db.events.delete_event_days(
            "device1",
            "upload",
            pendulum.datetime(2015, 2, 6, 12, 0, tz="UTC").int_timestamp,
            pendulum.datetime(2015, 2, 6, 12, 0, tz="UTC").int_timestamp,
        ...
        self.assertEqual(len(res), 1)
        self.assertEqual(
            res[0].ts, pendulum.datetime(2015, 2, 5, 18, 0, tz="UTC").int_timestamp
        )
